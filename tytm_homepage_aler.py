...
while (True):
    try:
        # ブラウザーを起動
        options = Options()
        options.binary_location = r'C:\Users\Ayuto\AppData\Local\Google\Chrome SxS\Application\chrome.exe'
        ...
        if not (old_HP_News == new_HP_News):
            ...
            driver.find_element_by_xpath('//*[@id="react-root"]/div/div/div[2]/main/div/div/form/div/div[1]/label/div/div[2]/div/input').send_keys("aaa25865945")

            driver.find_element_by_xpath('//*[@id="react-root"]/div/div/div[2]/main/div/div/form/div/div[2]/label/div/div[2]/div/input').send_keys("Ayuayu1215")
